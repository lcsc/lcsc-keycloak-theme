...
<div id="welcomeScreen" style="display:none;height:100%">
    ...
    <img src="${resourceUrl}/img/logo-ingles-LCSC.png">
    <img src="${resourceUrl}/img/Ministerio_eco.svg">
    <img src="${resourceUrl}/img/csic-ptic.png">
    <img src="${resourceUrl}/img/layout_set_logo.jpeg">
    <img src="${resourceUrl}/img/eead.png">
    <img src="${resourceUrl}/img/logo-araid.png">
    </div>
      </main>
    </div>
</div>
