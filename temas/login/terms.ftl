...
<@layout.registrationLayout displayMessage=false; section>
    ...
    <div id="kc-terms-text">
        <h2>Services</h2>
            <p>LCSC provides SPEI datasets available for General Users (unregistered) a Open Database license (see below). Limited to historical data<sup>*</sup>.
        ...
        <div class="alert-warning ${properties.kcAlertClass!} pf-m-warning">
            ...
            <strong>*</strong>: Real Time and historical data definition depens on the dataset. But by default means 3 weeks from the current.
            </div>
        </div>
        ...
        <div class="contentText">
            <p>The LCSC's datasets are made available under the
                <a href="http://opendatacommons.org/licenses/odbl/1.0/">
                    Open Database License</a>. Any rights in individual contents of the database are
                licensed under the <a href="http://opendatacommons.org/licenses/dbcl/1.0/">
                    Database Contents License</a>. 
            </p>
            <p>Registered Users can request a custom license.
            </p>
