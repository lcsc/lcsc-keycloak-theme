    ...
    <div class="container">
        ...
        <div class="col-sm-9 content-area">
            <div class="lcsc-logos">
                ...
                <img src="${url.resourcesPath}/img/csic-ptic.png">
                <img src="${url.resourcesPath}/img/layout_set_logo.jpeg">
                <img src="${url.resourcesPath}/img/eead.png">
                <img src="${url.resourcesPath}/img/logo-araid.png">
            </div>
